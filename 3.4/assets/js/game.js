...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    // switch turn order for next round !swaps boolen from being true to false
...
var getPlayerName = function() {
  var name = "";
  while (name === "" || name === null)  //while name is empty or null then ask what is your robots name
